        ...
        <div className='w-full md:w-1/2 bg-white shadow rounded-lg p-5'>
            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <div className='my-3'>
                    ...
                    <input type="text" name="web" id="" className='border bg-gray-50 w-full p-2 rounded-lg'  value={perfil.web || ''} onChange={ e => setPerfil ({
                        ...perfil,
                        [e.target.name] : e.target.value
                    })} />
                </div>
                <div className='my-3'>
                    ...
                    <input type="text" name="telefono" id="" className='border bg-gray-50 w-full p-2 rounded-lg' value={perfil.telefono || ''} onChange={ e => setPerfil ({
                        ...perfil,
                        [e.target.name] : e.target.value
                    })} />
                </div>
                <div className='my-3'>
                    ...
                    <input type="text" name="email" id="" className='border bg-gray-50 w-full p-2 rounded-lg' value={perfil.email || ''} onChange={ e => setPerfil ({
                        ...perfil,
                        [e.target.name] : e.target.value
                    })} />
                </div>
